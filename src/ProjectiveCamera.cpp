...
std::vector<Ray> ProjectiveCamera::GetRayAt([[ maybe_unused ]] int x, [[ maybe_unused ]] int y, [[ maybe_unused ]] const ImagePlane& p) const
{
    ...
    Point3D origin {0.0, 0.0, 0.0}; // TODO REMOVE
    std::vector<Ray> rays;
